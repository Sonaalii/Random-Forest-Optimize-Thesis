...
# Efficient model loading using caching to avoid reloading the model repeatedly
@st.cache_resource
def load_model():
    model = joblib.load('churn_model_with_threshold_compressed_________.joblib')
    return model

loaded_model = load_model()  # Load model only once per session
