...
# # Load the trained model with threshold 0.3
# with open('churn_model_with_threshold_.pkl', 'rb') as f:
#     model = pickle.load(f)
# Load the compressed trained model with threshold 0.3
with open('churn_model_with_threshold_compressed.pkl', 'rb') as f:
    model = pickle.load(f)
